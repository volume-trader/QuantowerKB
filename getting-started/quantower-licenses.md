...
**Free license** is granted by default once you have created a VT-Terminal Account. Also, it will be available all the time when you don’t have any active paid License. Using Free license you will get:
...
![Order payment for VT-Terminal license](../.gitbook/assets/orderpayment-quantower-google-chrome-2019-05-16-11.24.10.png)

After that, you will be redirected to the provider’s payment page. Once you complete all the payment steps, you will be redirected back to the confirmation page of VT-Terminal Accounts. Follow the **GO TO DASHBOARD** link to get to your VT-Terminal Account dashboard, where you should see you current Core License information and Payment transactions history.

## License terms

Currently, all licenses can be purchased for a 1-month term minimum. You can also get any VT-Terminal paid License for the LIFETIME period — [contact our support](https://www.quantower.com/contact-us) for this.
...
* A free License is valid ALL THE TIME while your VT-Terminal Account is active.
